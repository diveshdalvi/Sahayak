...
import { User, Calendar, Phone, MapPin, Droplet, CreditCard, UserCheck } from 'lucide-react';
      ...
      <div className="max-w-3xl mx-auto px-4">
        <div className="bg-white rounded-lg shadow-md overflow-hidden">
          ...
          <div className="divide-y divide-gray-100">
            <InfoRow icon={Calendar} label="Date of Birth" value={userProfile.dob} />
            <InfoRow icon={UserCheck} label="Gender" value={userProfile.gender} />
            <InfoRow icon={Phone} label="Phone Number" value={userProfile.phone} />
            <InfoRow icon={MapPin} label="Area" value={userProfile.area} />
            <InfoRow icon={Droplet} label="Blood Type" value={userProfile.bloodType} />
            <InfoRow icon={CreditCard} label="Aadhaar Number" value={userProfile.aadhaar} />
