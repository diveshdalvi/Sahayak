...
const Home = () => {
  ...
  const [locations] = useState([
    {
      id: 1,
      name: "Possible risk of Dengue",
      description: "Mosquito breeding site detected",
      lat: 19.0758,
      lng: 73.0129,
      dangerLevel: "high",
      events: ["Dengue Alert", "Emergency Response Standing By"],
    ...
    },
    {
      ...
      description: "Heavy rainfall warning in low-lying area",
      lat: 19.033,
      lng: 73.0297,
      dangerLevel: "medium",
      events: ["Flood Alert", "Emergency Response Standing By"],
      radius: getDangerRadius("medium"),
      color: getDangerColor("medium"),
    },
    {
      id: 3,
      name: "Possible risk of Malaria",
      description: "Stagnant water reported in residential area",
      lat: 19.0454,
      lng: 73.0395,
      dangerLevel: "high",
      events: ["Malaria Alert", "Emergency Response Standing By"],
      radius: getDangerRadius("high"),
      color: getDangerColor("high"),
    },
    {
      ...
      description: "Active fire in commercial district",
      lat: 19.0682,
      lng: 73.0179,
      dangerLevel: "high",
      events: ["Fire Fighting Operation", "Area Cordoned Off"],
      radius: getDangerRadius("high"),
      color: getDangerColor("high"),
    },
    {
      id: 5,
      name: "Road Collapse Risk",
      description: "Road structural damage reported",
      lat: 19.0523,
      lng: 73.0159,
      dangerLevel: "medium",
      events: ["Road Repair Work", "Traffic Advisory"],
      radius: getDangerRadius("medium"),
      color: getDangerColor("medium"),
    },
  ]);
